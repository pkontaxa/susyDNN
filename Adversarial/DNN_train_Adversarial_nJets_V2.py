...
data_dir = '/media/pantelis/ESD-USB/For_Parametric_Training/preprocessedData_Adversarial_25June2020_Splitted_Signal/'
train_path = data_dir + 'train_set_reduced_bkg_Compressed.root'
test_path = data_dir + 'test_set_reduced_bkg_Compressed.root'
...
save_path = '/home/pantelis/Desktop/susyDNN/susyDNN/models_Adversarial_25June2020_Splitted_Signal/COMPRESSED/'
...
for i in range(num_epochs):
	...
	print("Loss L_r: " + str(losses["L_r"][-1] / lam))
	    ...
	    plot_jensenshannon(i, js_distances, lam, num_epochs, 'JS_distance_reduced_bkg_lambda'+str(lam))
            plot_Inefficiencies(i, inefficiencies, lam, num_epochs, 'Inefficiencies_reduced_bkg_lambda'+str(lam)) 

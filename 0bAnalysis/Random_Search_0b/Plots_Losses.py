...
out_dir = '/afs/cern.ch/work/p/pakontax/private/susyDNN/susyDNN/plots_Random_Search_0b/'
...
def plot_jensenshannon(i, distances, lam, num_epochs, save_name):
	...
	if(i==num_epochs-1):
		plt.plot(range(len(js1)), js1, label="nJet = [3,4] vs [5,6,7]", color="red")
		plt.plot(range(len(js2)), js2, label="nJet = [5,6,7] vs. [>=8]", color="blue")
		plt.ylim([0,1])
